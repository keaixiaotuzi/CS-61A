...
def replace_loki_at_leaf(t, lokis_replacement):
    ...
    return tree(label(t), [replace_loki_at_leaf(l, lokis_replacement)for l in branches(t)])
...
def check_par():
    ...
    True
    """
    r1 = interval(-10, -10)  # Replace this line!
    r2 = interval(-10, -8)  # Replace this line!
    return r1, r2
...
#             for k in range(m, 10):
#                 r1 = interval(i, j) # Replace this line!
#                 r2 = interval(m, k)

#                 x = par1(r1, r2)
#                 y = par2(r1, r2)
#                 print(lower_bound(x) != lower_bound(y) or upper_bound(x) != upper_bound(y))
#                 print(r1, r2)